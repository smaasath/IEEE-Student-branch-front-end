...
import ViewEventModal from '../../../components/models/viewEventModel/viewEventModel';
...
const CommonEventCard = ({
 ...
 // Define state for modal visibility and selected event
 const [viewEventModalShow, setViewEventModalShow] = useState(false);
 const [selectedEvent, setSelectedEvent] = useState(null); // Add this state for the selected event
...
className="bg-transparent border-0"
 ...
 {editable && (
<button className="bg-transparent border-0" onClick={editAction}>
