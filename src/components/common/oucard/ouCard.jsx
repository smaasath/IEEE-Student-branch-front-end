...
const OuCard = ({ name, type, logo, onclick }) => {
  return (
    <div className="card btn m-0 p-0 shadow-sm rounded-5 ">
      <img src={logo} className="card-img-top body-bag-secondary pt-3 pb-2 px-2 align-middle rounded-top-5" alt="" />
