    ...
    <AuthLayout type={'SIGNUP'}>
      <div className='d-flex w-100 justify-content-between align-items-start'>
        ...
        <div className='d-flex flex-column '>
          ...
          <div className=''>
            <Link href={`/`} className="nav-link"><p className='text-cl-primary'>Sign in</p></Link>
          </div>
        </div>
      </div>
      ...
      <div className='mt-3 d-flex gap-3 justify-content-between align-items-center '>
        ...
        <div className="mb-3">
          ...
          <input type="number" className="form-control" id="exampleFormControlInput1" placeholder="contact no" />
        </div>
      </div>
