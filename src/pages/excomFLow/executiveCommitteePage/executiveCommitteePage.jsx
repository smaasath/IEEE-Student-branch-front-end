    ...
    return (
        <div className='p-3'>
            <div className='d-flex justify-content-end gap-4 align-items-center flex-wrap'>
                ...
                <div><CommonButton onClick={navigateToexcomDetailPage} text={"Excom Details"} /></div>
            </div>
            ...
            {selectedTask && <TaskDetailModel show={true} onHide={closeTaskDetailModel} taskData={{ title: selectedTask }} />}
        </div>
    );
}
